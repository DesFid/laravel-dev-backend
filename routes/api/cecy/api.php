...
use App\Http\Controllers\Cecy\AgreementCompanyController;
use App\Http\Controllers\Cecy\PlanificationController;
use App\Http\Controllers\Cecy\DepartmentDataController;
...
Route::group(['prefix' => 'academic_record'], function () {
    ...
    Route::apiResource('', AgreementCompanyController::class);
...
Route::group(['prefix' => 'catalogues'], function () {
    Route::apiResource('', CatalogueController::class);
...
Route::group(['prefix' => 'department_data'], function () {
    //Route::group(['middleware' => 'auth:api'], function () {
    Route::apiResource('', DepartmentDataController::class);
...
Route::group(['prefix' => 'planification'], function () {
    Route::get('filter', [PlanificationController::class, 'filter']);
    Route::get('courses', [PlanificationController::class, 'courses']);
    Route::get('{id}', [PlanificationController::class, 'getPlanification']);
